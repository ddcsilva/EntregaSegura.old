...
namespace EntregaSegura.API.Migrations
{
    ...
    [Migration("20230507172752_AlteracaoEstrutura")]
    partial class AlteracaoEstrutura
    {
            ...
            modelBuilder.Entity("EntregaSegura.Entities.Models.Condominio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a0875673-1846-41b7-a175-0da3d7ecd460"),
                            Bairro = "Bairro Exemplo",
                            CEP = "11111111",
                            CNPJ = "11111111111111",
                            Cidade = "Cidade Exemplo",
                            Complemento = "Bloco A",
                            DataAtualizacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6110),
                            DataCriacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6102),
            ...
            modelBuilder.Entity("EntregaSegura.Entities.Models.Entrega", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("826c10c7-0a9d-4676-8fdc-1c8ed5869cd4"),
                            DataAtualizacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6304),
                            DataCriacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6304),
                            DataRecebimento = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6306),
                            Descricao = "Descrição da entrega",
                            Destinatario = "Destinatario Exemplo",
                            FuncionarioId = new Guid("c5c9430c-3d61-462b-a9a9-85f3a4e0676e"),
                            MoradorId = new Guid("c076638d-7dfc-44dc-9701-f65c42e111f3"),
                            Observacao = "Observação da entrega",
                            Remetente = "Remetente Exemplo",
                            Status = 1,
                            TransportadoraId = new Guid("ec08a5fc-8353-41d4-829c-fc1e0c8a037d")
                        });
                });
            ...
            modelBuilder.Entity("EntregaSegura.Entities.Models.Funcionario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c5c9430c-3d61-462b-a9a9-85f3a4e0676e"),
                            CPF = "98765432109",
                            Cargo = 2,
                            CondominioId = new Guid("a0875673-1846-41b7-a175-0da3d7ecd460"),
                            DataAdmissao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6234),
                            DataAtualizacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6233),
                            DataCriacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6233),
            ...
            modelBuilder.Entity("EntregaSegura.Entities.Models.Morador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c076638d-7dfc-44dc-9701-f65c42e111f3"),
                            CPF = "12345678901",
                            DataAtualizacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6218),
                            DataCriacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6218),
                            Email = "morador@email.com",
                            Nome = "Morador Exemplo",
                            Status = 2,
                            Telefone = "11999999999",
                            UnidadeId = new Guid("fffc9618-f8f0-4137-bedc-7bcb43e52b0d")
                        });
                });
            ...
            modelBuilder.Entity("EntregaSegura.Entities.Models.Transportadora", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec08a5fc-8353-41d4-829c-fc1e0c8a037d"),
                            CNPJ = "22222222222222",
                            DataAtualizacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6246),
                            DataCriacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6246),
            ...
            modelBuilder.Entity("EntregaSegura.Entities.Models.Unidade", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fffc9618-f8f0-4137-bedc-7bcb43e52b0d"),
                            Bloco = "A",
                            CondominioId = new Guid("a0875673-1846-41b7-a175-0da3d7ecd460"),
                            DataAtualizacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6204),
                            DataCriacao = new DateTime(2023, 5, 7, 14, 27, 52, 37, DateTimeKind.Local).AddTicks(6204),
                            Numero = "101"
                        });
                });
